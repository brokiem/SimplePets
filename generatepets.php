...
class generatepets {
    ...
    public static function main(): void {
        ...
        foreach ($constants as $constant => $value) {
            ...
            $contents .= "use pocketmine\\entity\EntitySizeInfo;\n\n";
            $contents .= "class " . $const . " extends BasePet {\n\n";
            $contents .= "public static function getNetworkTypeId(): string {\n";
            $contents .= "return \"$value\";\n}\n\n";
            $contents .= "public function getPetType(): string {\n";
            $contents .= "return \"$const\";\n}\n\n";
            $contents .= "protected function getInitialSizeInfo(): EntitySizeInfo {\n";
            $contents .= "return new EntitySizeInfo(0.85, 0.8);\n}\n}";
