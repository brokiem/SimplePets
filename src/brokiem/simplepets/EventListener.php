...
final class EventListener implements Listener {
    ...
    public function onJoin(PlayerJoinEvent $event): void {
        ...
        if ($player->hasPermission("simplepets.notify") and !empty(SimplePets::getInstance()->cachedUpdate)) {
            ...
            if (SimplePets::getInstance()->getDescription()->getVersion() !== $latestVersion) {
                $player->sendMessage(" \n§aSimplePets §bv$latestVersion §ahas been released on §b$updateDate. §aDownload the new update at §b$updateUrl\n ");
            }
        }
